      ...
      <div className="flex-1 flex flex-col">
        ...
        {ctaText && (
          <button
            ...
            className="mt-6 w-full py-3 px-6 bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-primary-light)] text-white font-bold rounded-xl active:scale-[0.98] transition-transform cursor-pointer"
          >
            {ctaText}
          </button>
        )}
